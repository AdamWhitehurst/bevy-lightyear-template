...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **CRITICAL: SUB-AGENT DIRECTION:**
   ...
   - **YOU synthesize**: Only YOU (the main research agent) create the final research document in doc/research/
...
5. **Gather metadata for the research document:**
   ...
   - Filename: `doc/research/YYYY-MM-DD-description.md`
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Repository**: [Repository name]
     ...
     [Relevant insights from doc/ directory with references]
     - `doc/something.md` - Historical decision about X
     - `doc/local/notes.md` - Past exploration of Y
     Note: Paths exclude "searchable/" even if found there

     ## Related Research
     [Links to other research documents in doc/research/]
...
- The doc/ directory provides historical context to supplement live findings
...
- Explore all of doc/ directory, not just research subdirectory
...
- **SUB-AGENTS DO NOT CREATE FILES**: Only the main research agent creates the final document in doc/research/
