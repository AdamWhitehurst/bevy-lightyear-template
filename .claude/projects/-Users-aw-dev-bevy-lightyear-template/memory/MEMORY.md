...
- **Ability system**: `ActiveAbility` is a prespawned/predicted entity (not a component on characters). Spawned with `PreSpawned` salt,
  `prediction_despawn()` on completion.
