...
authoritative deletion, arm same-chunk moves with local-only previews before the server commits the new position, and rotate
selected objects with persisted yaw. Free-form spawning remains client-local.
